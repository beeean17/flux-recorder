...
MAIN_WINDOW_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "ko": {
        ...
        "stop_recording_title": "녹화를 중지할까요?",
        "stop_webcam_message": "메뉴로 돌아가면 현재 녹화가 중지됩니다. 계속할까요?",
        "stop_screen_message": "메뉴로 돌아가면 현재 화면 녹화가 중지됩니다. 계속할까요?",
        "language_switch_title": "언어 전환",
        "stop_webcam_before_language": "현재 웹캠 녹화를 중지한 뒤 언어를 변경하세요.",
        "stop_screen_before_language": "현재 화면 녹화를 중지한 뒤 언어를 변경하세요.",
